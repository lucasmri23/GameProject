...
draw_text(gui_width/2,gui_height/9,"Game Over!");

var frame = min(7, sprite_get_number(spr_player_death) - 1);
var escala = 8;
draw_sprite_ext(spr_player_death, frame, gui_width / 2, (gui_height / 9) + margin, escala, escala, 0, c_white, 1);

var x1 = gui_width / 2;
var sprite_h = sprite_get_height(spr_player_death) * escala;
