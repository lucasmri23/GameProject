...
            if (dist_ok) {
                with (obj_enemy1) { // Verifica a distância para outros inimigos já existentes
...
                criados++;
                ...
                var sala_do_inimigo_id = grid_sala[# cx, cy];
                if (ds_map_exists(global.salas, sala_do_inimigo_id)) {
                    novo_inimigo.minha_sala_id = sala_do_inimigo_id;
                    global.salas[? sala_do_inimigo_id].inimigos_ativos_count++;
                }
            }
        }
    }
