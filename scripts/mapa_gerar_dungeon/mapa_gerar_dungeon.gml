...
        var sala_index;
		...
		if (sala_existente == -1) {
			...
			// A atribuição de global.salas[? nova_sala.id] = nova_sala;
			// foi movida para o obj_map Create Event para garantir que global.salas
			// já esteja criado e que todas as salas sejam adicionadas de uma vez após a geração completa.
            ...
            // Estas conexões são para global.grafo, que usa ds_map, não a struct Sala
            // As conexões na struct Sala são adicionadas mais abaixo.
